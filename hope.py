...
ball_0 = sphere(pos = vec( -10, height, 0), radius = size, color=color.red) # the ball
ball_1 = sphere(pos = vec( 0, height, 0), radius = size, color=color.green) # the ball
ball_2 = sphere(pos = vec( 10, height, 0), radius = size, color=color.blue) # the ball
